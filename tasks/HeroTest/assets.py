...
class HeroTestAssets: 
	...
	# 兵藏秘境选择乘胜 
	I_BCMJ_SKILL_ADD1 = RuleImage(roi_front=(1110,361,67,32), roi_back=(103,359,1076,37), threshold=0.8, method="Template matching", file="./tasks/HeroTest/as/as_bcmj_skill_add1.png")
	# 技能选择 绝命 
	I_BCMJ_SKILL_ADD2 = RuleImage(roi_front=(821,357,63,34), roi_back=(106,356,1068,38), threshold=0.8, method="Template matching", file="./tasks/HeroTest/as/as_bcmj_skill_add2.png")
	# 技能祝福确定 
	...
	# 鬼兵部满级图标
	I_GBB_FULL_LEVEL = RuleImage(roi_front=(172,491,29,26), roi_back=(166,486,58,36), threshold=0.8, method="Template matching", file="./tasks/HeroTest/as/as_gbb_full_level.png")
